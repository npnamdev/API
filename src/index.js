...
fastify.register(require('./routes/heroBanner.route'), { prefix: (process.env.API_PREFIX || '/api') + '/hero-banner' });
fastify.register(require('./routes/testimonial.route'), { prefix: (process.env.API_PREFIX || '/api') + '/testimonials' });
